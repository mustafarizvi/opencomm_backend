...
public abstract class AbstractConnection
{
   ...
   private class _globalhandler implements org.freedesktop.main.DBus.Peer, org.freedesktop.main.DBus.Introspectable
   {
   ...
   */
   ...
   public void disconnect()
   {
      ...
      if (Debug.debug) Debug.print(Debug.INFO, "Sending disconnected signal");
		try {
			handleMessage(new org.freedesktop.main.DBus.Local.Disconnected("/"));
		} catch (Exception ee) {
